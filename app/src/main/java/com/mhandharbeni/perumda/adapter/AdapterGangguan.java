...
public class AdapterGangguan extends RecyclerView.Adapter<AdapterGangguan.ViewHolder> {
    List<DataGangguan> listGangguan = new ArrayList<>();
    Context context;
    ListenerGangguan listenerGangguan;

    public AdapterGangguan(List<DataGangguan> listGangguan, Context context, ListenerGangguan listenerGangguan) {
